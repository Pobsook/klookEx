    ...
    <nav>
      ...
      <div className="navTopLeft">
        ...
        <div className="conSearch">
          <input type="search" onFocus={openSearch} className="navSearchBar" placeholder="Search destinations or activities" />
          <label className="iconSearch" >
            <i className="fas fa-search"></i>
          </label>
          <div className="conSearchList" style={{ display: `${openModalSearch ? "flex" : "none"}` }}>
            <div>
